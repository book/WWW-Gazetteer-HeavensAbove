...
Diacritic characters, such as ¸ and ƒ can either be entered directly
...
'‰', '‡', '·', '‚', '„' and 'Â'). If you need a special character which
is not on your keyboard, and is not a diacritic (e.g. the german 'ﬂ',
and scandinavian 'Ê'), simply enter a "?" instead, and all characers
will be matched.
...
sub getpage {
    ...
    if ( $count == -1 ) {
        ...
        if ( $string =~ y/*// == 1 ) {
            ...
            $string =~
              tr{¿¡¬√ƒ≈‡·‚„‰Â«Á»… ÀËÈÍÎÃÕŒœÏÌÓÔ–—Ò“”‘’÷ÿÚÛÙıˆ¯Ÿ⁄€‹˘˙˚¸›˝ˇ}
